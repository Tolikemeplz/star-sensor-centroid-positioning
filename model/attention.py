...
# 从get_freq_indices到MultiSpectralDCTLayer是fca模块的代码
...
class MultiSpectralAttentionLayer(torch.nn.Module):
    def __init__(self, channel, reduction=16, freq_sel_method='top16'):
        ...
        c2wh = dict([(96, 56), (192, 28), (384, 14), (768, 7)])
        self.dct_h = c2wh[channel]
        self.dct_w = c2wh[channel]

        mapper_x, mapper_y = get_freq_indices(freq_sel_method)
        self.num_split = len(mapper_x)
        mapper_x = [temp_x * (c2wh[channel] // 7) for temp_x in mapper_x]
        mapper_y = [temp_y * (c2wh[channel] // 7) for temp_y in mapper_y]
        # make the frequencies in different sizes are identical to a 7x7 frequency space
        # eg, (2,2) in 14x14 is identical to (1,1) in 7x7

        self.dct_layer = MultiSpectralDCTLayer(c2wh[channel], c2wh[channel], mapper_x, mapper_y, channel)
        self.fc = nn.Sequential(
...
# 从BasicConv到TripletAttention是Triplet Attention的代码
